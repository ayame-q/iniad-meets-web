	...
	<article class="teaser">
		<div class="info">
			...
			<p class="datetime"><time>
				<span class="date">2021.4.28 Wed.</span>
				<span class="time">18:00 Open, 18:30 Start</span>
			</time></p>
			<ul class="sns-share">
				<li>
					<a href="https://twitter.com/intent/tweet?url=https://meets.iniad.net&text=INIADのサークル情報満載！「INIAD meets web」2021.4.28 18:00開場 &hashtags=INIADmeetsweb&related=iniad_webmedia&via=iniad_webmedia">
						<font-awesome-icon v-bind:icon="['fab', 'twitter']"></font-awesome-icon>
						ツイート
					</a>
				</li>
				<li class="sns-share-line">
					<a href="https://line.me/R/msg/text/?INIADのサークル情報満載！「INIAD meets web」2021.4.28 18:00開場 https://meets.iniad.net" class="sns-share-line">
		...
		<p class="times-pr"><a href="https://iniad-wm.com/" target="_blank">INIAD情報満載のオンライン情報誌<br>「INIAD Times」もぜひご覧ください！</a></p>
	</article>
</template>
...
.teaser{
	text-align: right;
	font-size: min(1.8vw, calc(1.8vh / 9 * 16));
	width: min(100vw, calc(100vh / 9 * 16));
	height: min(calc(100vw / 16 * 9), 100vh);
	background-image: url("../assets/img/teaser-background.png");
