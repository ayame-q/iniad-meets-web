...
urlpatterns = [
    ...
    path('api/v2/slack/', views.SlackChallengeAPI.as_view(), name="slack_challenge"),
    path('api/v2/slack/team_join', views.SlackNewUserAPI.as_view(), name="slack_new_user_join"),
